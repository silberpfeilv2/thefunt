...
module.exports = {
        ...
        alternatifler: ['random-cat', 'kedipng', 'kedijpg', '🐱'], //komutun asıl adı dışında kullanılabileceği alternatifler. Örneğin; (komut adını x olarak düşünürsek) alternatifler: ["y", "z"], olabilir mesela.
